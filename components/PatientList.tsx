      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        ...
        <div className="space-y-4 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                ...
                <div className="md:col-span-8 flex flex-col md:flex-row items-center gap-2">
                    <span className="text-sm text-gray-500 whitespace-nowrap">วันนัดหมาย:</span>
                    <input 
                        type="date" 
                        value={apptStartDate} 
                        onChange={(e) => setApptStartDate(e.target.value)} 
                        className="w-full md:w-auto px-3 py-2 border border-gray-300 rounded-md focus:ring-emerald-500 focus:border-emerald-500 text-sm" 
                    />
