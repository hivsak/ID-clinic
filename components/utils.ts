...
// --- Shared Logic for HCV Status ---

export type HcvDiagnosticStatus = 'POSITIVE' | 'INCONCLUSIVE' | 'NEGATIVE' | 'UNKNOWN';

export const determineHcvDiagnosticStatus = (tests: HcvTest[]): HcvDiagnosticStatus => {
...
export const determineHcvStatus = (hcvInfo: HcvInfo): { text: string; color: string } => {
